---
{"dg-publish":true,"permalink":"/archive/etike/notes/"}
---
...
- finding maps
- tracking friends
- Smartphones serve as electronic wallets
- control home appliances from a distance.

### Problems: 
- Location tracking raises privacy concerns
- Talking or texting on cell phones while driving is dangerous
- Cameras in cell phones affect privacy in public and non-public places
- Rudeness is an issue with cellphones: Cell phones can interfere with solitude, quiet and concentration
#### Other unanticipated negative applications:
- teenagers sexting
- terrorists detonating bombs
- rioters organizing looting parties.

## Kill switches
- Allow a remote entity to disable applications and delete files
- Are in operating systems for smartphones, tablets and computers
- Used mainly for security but raise concerns about user autonomy.

### Amazon & Google – Kill Switches and User Control

- **Amazon Kindle Case**
    
    - A seller sold copyrighted books illegally.
        
    - Amazon deleted the books from users’ devices and refunded them.
        
    - Users were shocked that Amazon could remove content remotely.
        
    - This right was hidden in long user agreements that most people don’t read.
        
- **Google Android Case (2011)**
    
    - Malicious code was found in an Android app.
        
    - Google removed it from the store and from over 250,000 phones.
        
    - This showed the use of a “kill switch” for security purposes.
        
    - Many users were surprised that Google could control their devices remotely.
        
    - Apple has similar capabilities.
        

### Ethical Issue

- Companies can remotely delete content or apps.
    
- Even if legal, users are often unaware.
    
- Raises concerns about ownership, privacy, and control.
...
- Socialbots simulate humans:
	- A person you follow in social media might not be a person at all
	- *“on the Internet, no one knows you’re a dog”*
	- A socialbot is an artificial intelligence program that simulates a human being in social media;


## Telemedicine:

Long-distance medicine refers to remote performance of medical exams, analyses, and procedures using specialized equipment and computer networks.
